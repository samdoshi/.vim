...
call <sid>hi("Conditional",                 s:gui0D, ""     , s:cterm0D, ""       , "")
...
call <sid>hi("Operator",                    s:gui0D, ""     , s:cterm0D, ""       , "")
call <sid>hi("PreProc",                     s:gui0A, ""     , s:cterm0A, ""       , "")
call <sid>hi("Repeat",                      s:gui0D, ""     , s:cterm0D, ""       , "")
call <sid>hi("Special",                     s:gui0C, ""     , s:cterm0C, ""       , "")
call <sid>hi("SpecialChar",                 s:gui0F, ""     , s:cterm0F, ""       , "")
call <sid>hi("Statement",                   s:gui0D, ""     , s:cterm0D, ""       , "")
...
call <sid>hi("GitGutterDelete",             s:gui09, s:gui01, s:cterm09, s:cterm01, "")
call <sid>hi("GitGutterChangeDelete",       s:gui0E, s:gui01, s:cterm0E, s:cterm01, "")

" Signify highlighting
call <sid>hi("SignifySignAdd",              s:gui0B, s:gui01, s:cterm0B, s:cterm01, "")
call <sid>hi("SignifySignChange",           s:gui0D, s:gui01, s:cterm0D, s:cterm01, "")
call <sid>hi("SignifySignDelete",           s:gui09, s:gui01, s:cterm09, s:cterm01, "")
